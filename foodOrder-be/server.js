...
let foods = [
  ...
  },
  {
    ...
    price: 45000,
    categoryId: 1,
    description: "Rendang daging sapi empuk dengan bumbu rempah pilihan.",
    categories: { categoryName: "Indonesian Food" },
  },
  {
    id: 60,
    ...
    price: 35000,
    categoryId: 2,
    description: "Pasta kenyal dengan saus daging sapi cincang khas Italia.",
    categories: { categoryName: "Western Food" },
  },
  {
    id: 61,
    name: "Sushi Roll Mentai",
    price: 40000,
    categoryId: 3,
    description: "Sushi gulung segar dengan saus mentai gurih yang dibakar.",
    categories: { categoryName: "Asian Food" },
  },
  {
    id: 62,
    name: "Pudding Cokelat Lumer",
    price: 12000,
    categoryId: 4,
    description: "Pudding cokelat manis dengan saus vla lumer di mulut.",
    categories: { categoryName: "Desserts" },
  }
];
let carts = [];
